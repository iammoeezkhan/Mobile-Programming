...
class Player {
  ...
  LookAround(Room) {
    if (RoomNo == 0) {
      console.log("You are in The Dungeon and it is a big damp room with broken statues all around");
      console.log("There is a doorway leading to the Entrance");
    }
    if (RoomNo == 1) {
      console.log("You Are In The Entrance");
    ...
    if (RoomNo == 2) {
      console.log("You Are In The Hallway and it is a long and dark hallway with dark pools of water and some fungus growing on the walls ");
      console.log("There are doorways leading to:");
    ...
    if (RoomNo == 3) {
      console.log("You Are In The The Chamber and it is a small chamber illuminated by some Glowing Portal");
      console.log("There are doorways leading to:")
      console.log("Hallway");
      console.log("Portal");
      console.log("You see a GiantDragon");
    }
    gameLoop();
  }
